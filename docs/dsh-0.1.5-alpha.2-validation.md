...
DSH 0.1.5-alpha.1/.2: the usage projection and settings.section client registration use unchanged public services; the Session V3 and Sidebar changes do not alter this surface. Source contract checks pass; provider usage and real Profile/UI acceptance remain separate gates.
